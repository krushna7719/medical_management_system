...
<div class="header">
  <h1>MY PHARMACY</h1>
 <p style="margin-top:-20px;line-height:1;font-size:30px;">SINHGAD INSTITUTE OF MANAGEMENT AND COMPUTER APPLICATION</p>
 <p style="margin-top:-20px;line-height:1;font-size:20px;">DEPARTMENT OF MCA</p>
</div>
<title>
MY PHARMACY
</title>
...
<body>
	...
	<div class=footer>
	<br>
	Developed by, Shrikrushna Wagh, 2022 
	<br><br>
	</div>
